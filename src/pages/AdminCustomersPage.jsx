...
import { Search, Plus, Upload, ExternalLink, X } from "lucide-react";
    ...
    <div style={{ padding: "24px 28px", maxWidth: 1080 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
        <div>
          ...
          <p style={{ fontSize: 13.5, color: "var(--muted)", margin: "4px 0 0" }}>{customers.length} loaded</p>
        </div>
...
const btnPrimary = { display: "flex", alignItems: "center", gap: 6, background: "var(--teal)", color: "#fff", border: "none", borderRadius: 9, padding: "9px 14px", fontSize: 13, fontWeight: 700 };
const btnSecondary = { display: "flex", alignItems: "center", gap: 6, background: "#fff", color: "var(--teal)", border: "1px solid var(--teal-border)", borderRadius: 9, padding: "9px 14px", fontSize: 13, fontWeight: 700 };

function AddCustomerModal({ agents, onClose, onDone }) {
  const [form, setForm] = useState({ name: "", phone: "", segment: "new_lead", source: "manual_upload", ltv: "", assigned_agent_id: "", product_name: "", sku: "" });
